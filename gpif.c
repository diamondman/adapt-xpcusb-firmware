...
// NextData SameData  SameData  SameData  SameData  SameData  SameData  SameData           
// Int Trig No Int    No Int    No Int    No Int    No Int    No Int    No Int             
// IF/Wait  Wait 1    Wait 1    Wait 1    IF        Wait 1    Wait 2    IF                 
//   Term A                               RDY0                          RDY1               
//   LFunc                                AND                           AND                
//   Term B                               RDY0                          RDY1               
// Branch1                                Then 4                        Then 0             
// Branch0                                Else 2                        ElseIdle           
// Re-Exec                                No                            No                 
// Sngl/CRC Default   Default   Default   Default   Default   Default   Default            
// CTL0         1         0         1         0         1         0         0         0    
// CTL1         0         0         1         1         1         1         1         1    
// CTL2         0         0         0         0         0         0         0         0    
// CTL3         0         0         0         0         0         0         0         0    
// CTL4         0         0         0         0         0         0         0         0    
// CTL5         0         0         0         0         0         0         0         0    
...
//                                                                                         
// AddrMode Same Val  Same Val  Same Val  Same Val  Same Val  Same Val  Same Val           
// DataMode Activate  Activate  Activate  Activate  Activate  Activate  NO Data            
...
// IF/Wait  Wait 1    Wait 4    Wait 3    IF        IF        Wait 1    IF                 
//   Term A                               RDY2      RDY1                RDY2               
//   LFunc                                AND       AND                 AND                
//   Term B                               RDY2      RDY1                RDY2               
// Branch1                                Then 4    Then 5              Then 6             
// Branch0                                Else 1    ElseIdle            ElseIdle           
// Re-Exec                                No        Yes                 Yes                
// Sngl/CRC Default   Default   Default   Default   Default   Default   Default            
// CTL0         0         1         0         0         0         0         0         0    
// CTL1         0         1         1         1         1         1         1         1    
// CTL2         0         0         0         0         0         0         0         0    
// CTL3         0         0         0         0         0         0         0         0    
// CTL4         0         0         0         0         0         0         0         0    
// CTL5         0         0         0         0         0         0         0         0    
...
// Wave 3 
/* LenBr */ 0x01,     0x04,     0x03,     0x21,     0xAF,     0x01,     0xB7,     0x07,
/* Opcode*/ 0x02,     0x02,     0x02,     0x03,     0x07,     0x12,     0x01,     0x00,
...
{                                                                
/* Regs  */ 0xA0,0x00,0x00,0x02,0xEA,0x4E,0x00     
};                                                               
// END DO NOT EDIT                                               
